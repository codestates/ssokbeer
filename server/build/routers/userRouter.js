...
userRouter.route("/signout").delete(_userController.signout);
userRouter.route("/profile").get(_userController.getProfile).patch(_userController.editProfile);
userRouter.route("/login").post(_userController.postLogin);
userRouter.route("/logout").delete(_userController.logout);
