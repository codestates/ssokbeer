...
## 2. UI/UX
- [ ] 회원가입, 로그인, 로그아웃, 마이페이지, 회원탈퇴 기능 구현 | 필수 | ★
- [ ] 회원가입, 로그인 및 회원정보 수정 시 유효성 검사 | 필수 | ★
- [ ] 소셜 로그인 외 서비스 자체 회원가입 기능 제공 | 필수 | ★
- [ ] 라이브러리를 사용하지 않고 React 컴포넌트 직접 작성 (유어클래스에서 다룬 것) | 필수 | ★
- [ ] 회원 탈퇴나 리소스 삭제시 확인(confirm) 모달 제공 | 권장 | ★
- [ ] 마이페이지를 통해 사용자 개인정보 수정 기능 제공 | 필수 | ★
- [ ] (소셜 로그인이 아닐 경우) 비밀번호 수정 기능 제공 | 필수 | ★
- [ ] 검색 필터링 기능 | 권장 | ★★★
- [ ] 무한 스크롤  | 도전 | ★★★
- [ ] 3rd-party API 호출 | 권장 | ★
